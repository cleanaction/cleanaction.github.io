      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <a href="#beranda" className="flex items-center gap-2 group" data-testid="logo">
            ...
            <span className="font-bold text-xl md:text-2xl uppercase tracking-tight" style={{ fontFamily: 'Space Grotesk' }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-gray-400 text-sm md:text-base uppercase tracking-wider" style={{ fontFamily: 'Space Grotesk' }}>
                {stat.label}
              </p>
            </div>
          ))}
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <p className="font-bold text-lg" style={{ fontFamily: 'Space Grotesk' }}>@cleanaction</p>
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-100">
                ...
                <div>
                  <p className="font-bold text-lg" style={{ fontFamily: 'Space Grotesk' }}>cleanaction.id</p>
          ...
          <div>
            <div className="bg-white border border-gray-200 p-6 brutalist-shadow">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <p className="font-bold" style={{ fontFamily: 'Space Grotesk' }}>@cleanaction</p>
              ...
              >
                ...
                */}
                ...
                <p className="font-bold text-gray-600 mb-2" style={{ fontFamily: 'Space Grotesk' }}>
                  Instagram Feed Live
                </p>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-8">
            <a href="#beranda" className="text-gray-400 hover:text-white transition-colors duration-300 uppercase text-sm tracking-wider" style={{ fontFamily: 'Space Grotesk' }}>Beranda</a>
            <a href="#tentang" className="text-gray-400 hover:text-white transition-colors duration-300 uppercase text-sm tracking-wider" style={{ fontFamily: 'Space Grotesk' }}>Tentang</a>
            <a href="#program" className="text-gray-400 hover:text-white transition-colors duration-300 uppercase text-sm tracking-wider" style={{ fontFamily: 'Space Grotesk' }}>Program</a>
            <a href="#kontak" className="text-gray-400 hover:text-white transition-colors duration-300 uppercase text-sm tracking-wider" style={{ fontFamily: 'Space Grotesk' }}>Kontak</a>
          </div>
